...
!(function (t, i) {
  ...
  var o = l.Marker.extend({
      initialize(t, i) {
        l.setOptions(this, i), (this._latlng = t), this.createIcon();
      },
      createIcon() {
        var t = this.options,
          i = [
            ["stroke", t.color],
            ["stroke-width", t.weight],
            ["fill", t.fillColor],
      ...
      setStyle(t) {
        l.setOptions(this, t), this.createIcon();
      },
    }),
    e = o.extend({
      initialize(t, i, s) {
        ...
        return {
          ...
          svg:
            `<svg xmlns="http://www.w3.org/2000/svg" width="${o}" height="${s}" version="1.1" viewBox="-${
              o / 2
            } 0 ${o} ${s}" transform="rotate(${this._heading})">` +
            `<path d="${t}" ${i} /></svg>`,
          w: o,
          h: s,
        };
  ...
  const n = l.Control.extend({
    options: {
      ...
      onLocationError(t, i) {
        ...
        featureDiv.className = "locAccess";
        featureDiv.innerHTML =
          "🚫 Geolocation Error: Access to location was denied by the user.";
    ...
    start() {
      this._activate(),
        this._event &&
          (this._drawMarker(this._map), this.options.setView) &&
          this.setView(),
        this._updateContainerStyle();
    },
    stop() {
    ...
    setView() {
      ...
      this._drawMarker(),
        this._isOutsideMapBounds()
          ...
          ? (this.options.flyTo ? this._map.flyTo : this._map.setView).bind(
              this._map
            )(
          ...
          ? (this.options.flyTo ? this._map.flyTo : this._map.panTo).bind(
              this._map
            )([this._event.latitude, this._event.longitude])
      ...
      (e = this.options.metric
        ...
        this.options.drawMarker &&
          ...
          this._marker
            ...
            : (this._marker = new this.options.markerClass(s, t).addTo(
                this._layer
              ))),
        this._drawCompass();
    ...
    _unload() {
      this.stop(), this._map && this._map.off("unload", this._unload, this);
    },
